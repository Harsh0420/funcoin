...
uint256 hashGenesisBlock("0x8a6baa8b15fa1a7654df0bf716ee1a9748779bc37da2a04e70824c23908be363");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 10000); // Funcoin: 10k blocks in ~4 years
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x21484b8ade0dead7aa54c8d11c3a0221efa99c12b852a6541c030e6204b7487c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04a2c7c561f93d2e7d952a04c32a38756c674ad72e550889dbf0f58e5dde67eb6e1ff05534ac8f8ab041e95359f69839cba81cf382ee8e3517193b28ffce592566") << OP_CHECKSIG;
        CBlock block;
        ...
        block.nNonce   = 2086291508;

        if (fTestNet)
        {
            block.nTime    = 1553325667;
            block.nNonce   = 1554080633;
        }
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x2aa9584f886b7356208c4461cad7ff8a493130dc6fc7e8f35390d050e5695bf7"));
        block.print();
